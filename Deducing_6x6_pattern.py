...
for table in range(times_of_trial):
    ...
    weight_list        = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[6]_weight_list.npy" , allow_pickle=True)
    slope_list         = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[6]_slope_list.npy"  , allow_pickle=True)
    weight_lists.append(weight_list)
    slope_lists.append(slope_list)

    weight_list        = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[7]_weight_list.npy" , allow_pickle=True)
    slope_list         = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[7]_slope_list.npy"  , allow_pickle=True)
    weight_lists.append(weight_list)
    slope_lists.append(slope_list)

    weight_list        = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[8]_weight_list.npy" , allow_pickle=True)
    slope_list         = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[8]_slope_list.npy"  , allow_pickle=True)
    weight_lists.append(weight_list)
    slope_lists.append(slope_list)

    weight_list        = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[9]_weight_list.npy" , allow_pickle=True)
    slope_list         = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[9]_slope_list.npy"  , allow_pickle=True)
    weight_lists.append(weight_list)
    slope_lists.append(slope_list)

    weight_list        = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[10]_weight_list.npy" , allow_pickle=True)
    slope_list         = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[10]_slope_list.npy"  , allow_pickle=True)
    weight_lists.append(weight_list)
    slope_lists.append(slope_list)

    weight_list        = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[11]_weight_list.npy" , allow_pickle=True)
    slope_list         = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[11]_slope_list.npy"  , allow_pickle=True)
    weight_lists.append(weight_list)
    slope_lists.append(slope_list)

    weight_list        = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[12]_weight_list.npy" , allow_pickle=True)
    slope_list         = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[12]_slope_list.npy"  , allow_pickle=True)
    weight_lists.append(weight_list)
    slope_lists.append(slope_list)

    weight_list        = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[13]_weight_list.npy" , allow_pickle=True)
    slope_list         = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[13]_slope_list.npy"  , allow_pickle=True)
    weight_lists.append(weight_list)
    slope_lists.append(slope_list)

    weight_list        = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[14]_weight_list.npy" , allow_pickle=True)
    slope_list         = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[14]_slope_list.npy"  , allow_pickle=True)
    weight_lists.append(weight_list)
    slope_lists.append(slope_list)

    weight_list        = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[15]_weight_list.npy" , allow_pickle=True)
    slope_list         = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[15]_slope_list.npy"  , allow_pickle=True)
    weight_lists.append(weight_list)
    slope_lists.append(slope_list)

    weight_list        = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[16]_weight_list.npy" , allow_pickle=True)
    slope_list         = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[16]_slope_list.npy"  , allow_pickle=True)
    weight_lists.append(weight_list)
    slope_lists.append(slope_list)

    weight_list        = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[17]_weight_list.npy" , allow_pickle=True)
    slope_list         = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[17]_slope_list.npy"  , allow_pickle=True)
    weight_lists.append(weight_list)
    slope_lists.append(slope_list)

    weight_list        = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[18]_weight_list.npy" , allow_pickle=True)
    slope_list         = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[18]_slope_list.npy"  , allow_pickle=True)
    weight_lists.append(weight_list)
    slope_lists.append(slope_list)

    weight_list        = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[19]_weight_list.npy" , allow_pickle=True)
    slope_list         = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[19]_slope_list.npy"  , allow_pickle=True)
    weight_lists.append(weight_list)
    slope_lists.append(slope_list)

    weight_list        = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[20]_weight_list.npy" , allow_pickle=True)
    slope_list         = np.load("self.6x6_original_1_100x100x100_30_0.000001_200m_[20]_slope_list.npy"  , allow_pickle=True)
    weight_lists.append(weight_list)
    slope_lists.append(slope_list)
